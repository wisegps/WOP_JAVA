...
public class GetGpsDataList {
	
	
	public static String Method_Gps_Datas_List = "wicare.gps_datas.list";
	
	public static void main(String [] args){
		Wop.init(TestConfig.appKey, TestConfig.appSecret);//初始化 appkey 和 appsecret 创建应用时可获得
		String fields = "rcv_time,lon,lat";
		WopApi.getGpsDataList(getParams(), fields,new Callback() {
